                ...
                let nombre=data[i].nombre
                  ...
                  if(miArreglo.includes(data[i].id)){
                    ...
                    <div class="card  card-margin ${colorNotas[random()]} "  style="max-width: 240px;"  >
                       <a href="#"  class="text-light p-1" onclick="eliminarAmigo(${data[i].id},'${nombre}')" >    
                       <p class="text-center fw-bold">${data[i].nombre} <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person-check-fill" viewBox="0 0 16 16">
                    ...
                    <div class="card  card-margin ${colorNotas[random()]} "  style="max-width: 240px;"  >
                       ...
                       <p class="text-center fw-bold">${data[i].nombre} <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                       <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
