...
function cargarMenuLogo(){
  const colorMenu=["l-bg-cherry","l-bg-blue-dark","l-bg-green-dark","l-bg-orange-dark","l-bg-cyan","l-bg-green","l-bg-orange","l-bg-cyan2"]
    ...
    <h3 class="d-inline  hover-3 " >MY NOTEBOOK'S</h3>
      <div id="btnMenus">
      </div>
...
function cargarMenu(){
  ...
  body=
  `<br>
  <ul class="nav   justify-content-center p-2 border-bottom  ">
  <li class="nav-item">
    <a class="nav-link fw-bold text-light active hover-3" aria-current="page" href="#" onclick="cargarCalendarioNotas('activas')">HOME</a>
  </li>
  <li class="nav-item">
    <a class="nav-link fw-bold text-light active hover-3" href="#" onclick="listaMateria()">MATERIAS</a>
  </li>
  <li class="nav-item">
    <a class="nav-link fw-bold text-light active hover-3"  href="#" onclick="cargarPerfil()" >PERFIL</a>
  </li>
  <li class="nav-item">
  <a class="nav-link fw-bold text-danger active hover-3" href="#" onclick="cerrarSesion()" >SALIR</a>
</li>

 
</ul>
<div id="nombreMenu" > <p >${nombre}</p></div>
`
