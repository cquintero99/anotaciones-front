...
function cargarIdMateria(data){
    ...
    .then(res=>res.json())
     .then(amigos=>{
      ...
      body=  `
        ...
        <p class="text-center fw-bold p-3">${data.estado}</p> </a>
        ...
        let estadoMateria=data.estado
        if(estadoMateria==="PUBLICA"){
          body= `
          <div class="card box8  card-margin ${colorNotas[random()]} p-3 "  style="max-width: 350px;"  >
          <div class="p-5 ">
          <a href="#"  class="text-light p-1" >    
          ...
          <div class="box-content">
            <ul class="icon text-center"  >
                <li  ><a href="#" data-bs-dismiss="offcanvas"  onclick="ingresarUsuarioMateria(${data.id} ,'${data.nombre}')" > 
  ...
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
          ...
          <div class="box-content">
            <ul class="icon text-center"  >
                <li  ><a href="#"  > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16">
